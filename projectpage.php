...
<div id="bigContainer">
  ...
  <!-- <nav>
    <table>
    <tr>
      <th class="navlink"><a href="#">Explore</a></th>
      <th class="navlink"><a href="#">About</a></th>
      <th><a href="#" class="logo">MooreStarter!</a></th>
      <th style="border-right:none;" class="navlink"><a href="#">Submit a Project</a></th>
    </tr>
  </table>
  </nav> -->
  ...
  <!-- <nav>
    <a href="#" class="navlink borderRight">Explore</a>
    <a href="#" class="navlink borderRight">About</a>
    <a href="#" class="logo">MooreStarter!</a>
    <a href="#" class="navlink borderLeft">Submit a Project</a>
  </nav> -->
  ...
  <div id="projectStart">
    ...
    <div id="projectStartRight">
      ...
      <div id="projectStartFeatures">
        ...
        <p>
          <ul>
            <li><span>Palm Precision accuracy</span></li>
            <li><span>Smartshake™ hand to height adjustment</span></li>
            <li><span>Assertive, shy, and friendly pressure grip modes</span></li>
          </ul>
        </p>
  ...
  <div id="projectContainer">
    ...
    <div id="projectAbout" class="plans 2d-plan active">
      ...
      <img src="images/handshakecropped.jpg" alt="">
